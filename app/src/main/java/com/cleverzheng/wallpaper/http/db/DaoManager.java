package com.cleverzheng.wallpaper.http.db;

import com.cleverzheng.wallpaper.http.download.DownloadManager;
import com.cleverzheng.wallpaper.http.download.TaskEntity;
import com.cleverzheng.wallpaper.http.download.TaskEntityDao;
