package com.wangzai.lovesy.core.util.storage;
...
public final class LoveSyPreference {
    /**
     * 提示:
    ...
    private static final SharedPreferences PREFERENCES =
            PreferenceManager.getDefaultSharedPreferences(LoveSy.getApplicationContext());
