package com.wangzai.lovesy.ui.user.photo;
...
public class UserPhotoFragment extends BaseRefreshFragment {

    @Override
    protected String setUrl() {
        final Bundle bundle = getArguments();
        final String username = bundle.getString(Constant.BUNDLE.ONE);
        return ApiService.User.USERS + username + "/" + ApiService.Photos.PHOTOS;
    }
    ...
    protected SimpleClickListener addItemClickListener() {
        return new UserPhotoItemClickListener(this);
    }
}
